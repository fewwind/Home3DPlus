...
import com.chaozhuo.threed.base.I3DLayout;
...
public class Game3DLayout extends FrameLayout implements I3DLayout{
    ...
    private ThreeDLayout view9;
    private ThreeDLayout view10;
    ...
    public Game3DLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(R.layout.layout_game_3d, this);
        ...
        view9 = findViewById(R.id.three_layout9);
        view10 = findViewById(R.id.three_layout10);
        initData();
    ...
    private void initData() {
        ...
        ThreeDBean bean9 = new ThreeDBean(des9, "game_9", 0, "", "");
        ThreeDBean bean10 = new ThreeDBean(des10, "game_10", 0, "", "");
        mListData.add(bean1);
        mListData.add(bean2);
        mListData.add(bean3);
        mListData.add(bean4);
